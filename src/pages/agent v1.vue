<template>
	...
	<div class="page-pading">
		...
		<view class="content">
			...
			<view class="top-page">
				...
				<div v-else>
					...
					<!-- <public-banner position="promotion_banner"></public-banner> -->
					<div class="card">
						<view class="statistics-user">

							<view class="statistics-card-integral">
								<div class="left-statistics-card-integral">
									<div class="icon-div">
										<img class="icon-1" src="@/assets/new/agent/icon-1.png" alt="">
									</div>
									<view class="statistics-card-integral-team">
										<text class="statistics-card-integral-team-name ellipsis">{{ $t('pageAgent.k1') }}</text>
										<text class="statistics-card-integral-team-num ">{{ unit }}{{
								...
								<view class="botton-view">
									<!-- drawCommission -->
									<view type="default" class="receber button" @click="$open('/agent-rebate')">
										<text v-show="!isSubmit">{{ $t('pageAgentPromotion.getReceive') }}</text>
										<public-loading v-show="isSubmit"></public-loading>
									</view>
								</view>
							</view>

							<div class="statistics-card-integral">
								<div class="left-statistics-card-integral">
									<div class="icon-div">
										<img class="icon-2" src="@/assets/new/agent/icon-2.png" alt="">
									</div>
									<view class="statistics-card-integral-team">
										<text class="statistics-card-integral-team-name ellipsis">{{ $t('pageAgent.k2') }}</text>
										<text class="statistics-card-integral-team-num">{{ unit }}{{
								...
								<view class="botton-view">
									<border-gradient class="btn" :border-color="['#FF92FF', '#00FFFF']"
												:border="1">
												<div type="default" class="registo button xx-btn" @click="$open('/agent-receive')">
										{{ $t('pageAgentPromotion.record') }}</div>
									</border-gradient>
					...
					<div class="card">
						<view class="statistics-card">
							<div class="statistics-card-title">{{ $t('pageAgent.k3') }}</div>
							<view class="statistics-card-div">
								<view class="statistics-card-team">
									<div class="statistics-name">
										<span class="pc">{{ userTeam.agent_sub_data_today.team_reg_num }}</span>	
										{{ $t('pageAgent.k31') }}
										<span class="h5">{{ userTeam.agent_sub_data_today.team_reg_num }}</span>	
									</div>
								</view>
								<view class="statistics-card-team">
									<div class="statistics-name">
										<span class="pc">{{ userTeam.agent_sub_data_today.new_reg_num ?? 0 }}</span>
										{{ $t('pageAgent.k32') }}
										<span class="h5">{{ userTeam.agent_sub_data_today.new_reg_num ?? 0 }}</span>
									</div>
								</view>
								<view class="statistics-card-team">
									<div class="statistics-num pc"> 
										<span>{{ unit }}{{ userTeam.agent_sub_data_today.team_bet_money ?? '0.0' }}</span>
									</div>
									<div class="statistics-name">{{ $t('pageAgent.k33') }}</div>
									<div class="statistics-num h5"> 
										<span>{{ unit }}{{ userTeam.agent_sub_data_today.team_bet_money ?? '0.0' }}</span>
									</div>
								</view>
								<view class="statistics-card-team">
									...
									<div class="statistics-name">{{ $t('pageAgent.k34') }}</div>
									<div class="statistics-num h5">
										<span>{{ unit }}{{ userTeam.agent_sub_data_today.team_commission_money ??
										'0.0' }}</span>
									</div>
							...
							<div class="statistics-card-title">{{ $t('pageAgent.k4') }}</div>
							<view class=" statistics-card-div">
								<view class="statistics-card-team">
									<div class="statistics-name">
										<span class="span pc">{{ userTeam.agent_sub_data.team_reg_num ?? 0 }}</span>	
										{{ $t('pageAgent.k41') }}
										<span class="span h5">{{ userTeam.agent_sub_data.team_reg_num ?? 0 }}</span>	
									</div>
								</view>
								<view class="statistics-card-team">
									<div class="statistics-name">
										<span class="pc">{{ userTeam.agent_sub_data.new_reg_num ?? 0 }}</span>	
										{{ $t('pageAgent.k42') }}
										<span class="h5">{{ userTeam.agent_sub_data.new_reg_num ?? 0 }}</span>	
									</div>
								</view>
								<view class="statistics-card-team">
									<div class="statistics-num pc">
										<span>{{ unit }}{{ userTeam.agent_sub_data.team_bet_money ?? '0.0' }}</span>
									</div>
									<div class="statistics-name">{{ $t('pageAgent.k43') }}</div>
									<div class="statistics-num h5">
										<span>{{ unit }}{{ userTeam.agent_sub_data.team_bet_money ?? '0.0' }}</span>
									</div>
								</view>
								<view class="statistics-card-team">
									<div class="statistics-num pc">
										<span>{{ unit }}{{ userTeam.agent_sub_data.team_commission ?? '0.0'
									}}</span>
									</div>
									<div class="statistics-name">{{ $t('pageAgent.k44') }}</div>
									<div class="statistics-num h5">
										<span>{{ unit }}{{ userTeam.agent_sub_data.team_commission ?? '0.0'
									}}</span>
									</div>
					...
					<div class="card">
						...
						<div class="ddv">
							<div class="menu-team-k">
								<div class="menu-team">
									<div class="menu-icon">
										<img src="@/assets/new/agent/Frame1.png" alt="">
									</div>
									<div class="menu-right">
										<div class="menu-right-top">
											<span class="menu-right-top-p1">{{ $t('pageAgent.p1') }}</span>
											<span class="menu-right-top-p2">{{ $t('pageAgent.p2') }}</span>
										</div>
										<div class="menu-right-bottom">
											<div class="menu-right-bottom-left">
												<span class="p1">{{ $t('pageAgent.p3') }}</span>
												<span class="p2">{{ unit }}{{ userTeam.agent_show_data.team_commission_month
												}}</span>
											</div>
											<border-gradient class="btn h5" :border-color="['#FF92FF', '#00FFFF']"
												:border="1">
												<div class="menu-btn" @click="$open('/agent-team')">{{ $t('pageAgent.p4') }}</div>
											</border-gradient>
										</div>

									</div>
									<border-gradient class="btn pc" :border-color="['#FF92FF', '#00FFFF']" :border="1">
										<div class="menu-btn" @click="$open('/agent-team')">{{ $t('pageAgent.p4') }}</div>
									</border-gradient>
								</div>
							</div>
							<div class="menu-team-k">
								<div class="menu-team">
									<div class="menu-icon">
										<img src="@/assets/new/agent/Frame2.png" alt="">
									</div>
									<div class="menu-right">
										<div class="menu-right-top">
											<span class="menu-right-top-p1">{{ $t('pageAgent.p21') }}</span>
											<span class="menu-right-top-p2">{{ $t('pageAgent.p22') }}</span>
										</div>
										<div class="menu-right-bottom">
											<div class="menu-right-bottom-left">
												<span class="p1">{{ $t('pageAgent.p23') }}</span>
												<span class="p2">{{ unit }}{{ userTeam.agent_show_data.my_commission_month
												}}</span>
											</div>
											<border-gradient class="btn h5" :border-color="['#FF92FF', '#00FFFF']"
												:border="1">
												<div class="menu-btn" @click="$open('/promotion-details')">{{ $t('pageAgent.p24') }}</div>
											</border-gradient>
										</div>
									</div>
									<border-gradient class="btn pc" :border-color="['#FF92FF', '#00FFFF']" :border="1">
							...
							<div class="menu-team-k">
								<div class="menu-team">
									<div class="menu-icon">
										<img src="@/assets/new/agent/Frame3.png" alt="">
									</div>
									<div class="menu-right">
										<div class="menu-right-top">
											<span class="menu-right-top-p1">{{ $t('pageAgent.p31') }}</span>
											<span class="menu-right-top-p2">{{ $t('pageAgent.p32') }}</span>
										</div>
										<div class="menu-right-bottom">
											<div class="menu-right-bottom-left">
												<span class="p1">{{ $t('pageAgent.p33') }}</span>
												<span class="p2">{{ $t('pageAgent.pp',{num:userTeam.agent_show_data.max_agent_bonus.bonus})  }}</span>
											</div>
											<border-gradient class="btn h5" :border-color="['#FF92FF', '#00FFFF']"
												:border="1">
												<div class="menu-btn" @click="$open('/agent-level')">{{ $t('pageAgent.p34') }}</div>
											</border-gradient>
										</div>
									</div>
									<border-gradient class="btn pc" :border-color="['#FF92FF', '#00FFFF']" :border="1">
							...
							<div class="menu-team-k">
								...
								<div class="menu-team">
									<div class="menu-icon">
										<img src="@/assets/new/agent/Frame4.png" alt="">
									</div>
									<div class="menu-right">
										<div class="menu-right-top">
											<span class="menu-right-top-p1">{{ $t('pageAgent.p41') }}</span>
											<span class="menu-right-top-p2">{{ $t('pageAgent.p42') }}</span>
										</div>
										<div class="menu-right-bottom">
											<div class="menu-right-bottom-left">
												<span class="p1">{{ $t('pageAgent.p43') }}</span>
												<span class="p2">{{ unit }}{{ userTeam.agent_show_data.max_commission_month
												}}</span>
											</div>
											<border-gradient class="btn h5" :border-color="['#FF92FF', '#00FFFF']"
												:border="1">
												<div class="menu-btn" @click="$open('/agent-rule')">{{ $t('pageAgent.p44') }}</div>
											</border-gradient>
										</div>
									</div>
									<border-gradient class="btn pc" :border-color="['#FF92FF', '#00FFFF']" :border="1">
		...
		<canvas canvas-id="canvasQRcode" ref="canvasQRcode" id="canvasQRcode" class="canvasQRcode"></canvas>
	</div>
<!-- </page> -->
</template>
...
import { onShow } from "../router/routes";
...
const qrDown = () => {
	let url = userTeam.domain[0].url
	let code = userTeam.inviteCode
